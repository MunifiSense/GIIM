        ...
        getUserCharacters().then(userCharResponse => {
            getUserItems().then(userItemResponse => {
                ...
                userCharResponse.data.forEach(character => {
                    ...
                    var desired_level = character.Users[0].UserCharacters.desired_level;
                    var normal_atk_level= character.Users[0].UserCharacters.normal_atk_level;
                    var normal_atk_desired_level= character.Users[0].UserCharacters.normal_atk_desired_level;
                    var q_atk_level= character.Users[0].UserCharacters.q_atk_level;
                    var q_atk_desired_level= character.Users[0].UserCharacters.q_atk_desired_level;
                    var e_atk_level= character.Users[0].UserCharacters.e_atk_level;
                    var e_atk_desired_level= character.Users[0].UserCharacters.e_atk_desired_level;
...
export async function retrieveNeeded(userItems){
    userItems = await setupNeededItems(userItems);
    userItems = await retrieveNeededWeaponItems(userItems);
    userItems = await retrieveNeededCharacterItems(userItems);
